...
class EntityOperationsTest extends KernelTestBase {
  ...
  public function testForwardRevisions() {
    ...
    $page->moderation_state_target_id= 'draft';
    $page->save();
    ...
    $page->setTitle('B');
    $page->moderation_state_target_id = 'published';
    $page->save();
  ...
  public function testArchive() {
    ...
    $page->moderation_state_target_id = $published_id;
    $page->save();
    ...
    $page->moderation_state_target_id = $archived_id;
    $page->save();
